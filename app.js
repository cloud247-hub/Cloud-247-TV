(() => {
  ...
  const i18n = {
    no: {
      ...
      benefit1Text: 'Koble til med QR/M3U, eller bruk Xtream Codes-login med server, brukernavn og passord direkte i Android-appen.',
    ...
    en: {
      ...
      benefit1Text: 'Connect with QR/M3U, or use Xtream Codes login with server, username and password directly in the Android app.',
      benefit2Title: 'Full TV guide',
