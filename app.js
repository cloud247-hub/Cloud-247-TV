(() => {
  ...
  const i18n = {
    no: {
      ...
      navPair: 'Koble TV',
      nativeApp: 'ANDROID · v1.4.0 · SAMSUNG TV · v1.0.3',
      eyebrowNew: 'DIN TV · DIN SPILLELISTE',
      heroNew1: 'TV-en din.',
      heroNew2: 'Spillelisten din.',
      leadNew: 'Cloud247 TV gir deg et ryddig TV-grensesnitt for din egen M3U-liste på Android TV, Android-nettbrett og Samsung TV – med full TV-guide, Night Mode og sportsvarsler med smart kanalmatching på Android-nettbrett.',
      pairTv: 'Koble TV',
      downloadAndroid: 'Android TV / Tablet',
      downloadSamsung: 'Samsung TV',
      pointDirect: 'Full TV-guide / EPG',
      pointQr: 'Sportsvarsler på Android-nettbrett',
    ...
    en: {
      ...
      leadNew: 'Cloud247 TV gives you a clean TV interface for your own M3U playlist on Android TV, Android tablets and Samsung TV, with a full TV guide, Night Mode and sports alerts with smart channel matching on Android tablets.',
      pairTv: 'Pair TV',
      downloadAndroid: 'Android TV / Tablet',
      downloadSamsung: 'Samsung TV',
      pointDirect: 'Full TV guide / EPG',
      pointQr: 'Sports alerts on Android tablets',
      pointLocal: 'Night Mode + sleep timer',
