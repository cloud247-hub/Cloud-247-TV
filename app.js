(() => {
  ...
  const i18n = {
    no: {
      navAndroid:'Android TV',navPair:'Koble TV',navWeb:'Webspiller',nativeApp:'ANDROID TV · v1.1.6',
      eyebrowNew:'DIN TV · DIN SPILLELISTE',heroNew1:'TV-en din.',heroNew2:'Spillelisten din.',
      leadNew:'Cloud247 TV gir deg et ryddig Android TV-grensesnitt for din egen M3U-liste – med QR-pairing, favoritter, smarte grupper og direkte avspilling fra TV-en.',
      pairTv:'Koble TV',downloadAndroid:'Last ned Android TV',tryWeb:'Prøv webspilleren',
      pointDirect:'Direkte avspilling på TV-en',pointQr:'QR-pairing på få sekunder',pointLocal:'Ingen videoproxy',
      previewSub:'DIN TV · DIN SPILLELISTE',norwegianChannels:'Norske kanaler',previewGroupAll:'Alle kanaler',previewGroup1:'Gruppe 1',previewGroup2:'Gruppe 2',previewGroup3:'Gruppe 3',previewChannel1:'Kanal 1',previewChannel2:'Kanal 2',previewChannel3:'Kanal 3',previewPlay:'åpner kanal',previewFav:'Hold OK for favoritt',
      ...
      benefit3Title:'Finn kanalene raskt',benefit3Text:'Favoritter, vanlige grupper, Norske kanaler og Premier League gjør store spillelister enklere å bruke.',
      webEyebrow:'WEBSPILLER · BETA',webTitle:'Vil du teste i nettleseren?',webLead:'Du kan fortsatt åpne M3U-listen her. Selve videostrømmen må støtte nettleseravspilling, CORS og riktig kodek. For vanlig TV-bruk anbefales Android TV-appen.',
      browserNoteTitle:'Hvorfor kan VLC virke når nettleseren ikke gjør det?',browserNoteText:'Nettlesere håndhever CORS og mixed-content-regler som native spillere ikke har. Derfor kan enkelte IPTV-kilder bare spilles i Android TV-appen eller VLC.',
    ...
    en: {
      navAndroid:'Android TV',navPair:'Pair TV',navWeb:'Web player',nativeApp:'ANDROID TV · v1.1.6',
      eyebrowNew:'YOUR TV · YOUR PLAYLIST',heroNew1:'Your TV.',heroNew2:'Your playlist.',
      leadNew:'Cloud247 TV gives you a clean Android TV interface for your own M3U playlist, with QR pairing, favourites, smart groups and direct playback on the TV.',
      pairTv:'Pair TV',downloadAndroid:'Download Android TV',tryWeb:'Try the web player',
      pointDirect:'Direct playback on the TV',pointQr:'QR pairing in seconds',pointLocal:'No video proxy',
      previewSub:'YOUR TV · YOUR PLAYLIST',norwegianChannels:'Norwegian channels',previewGroupAll:'All channels',previewGroup1:'Group 1',previewGroup2:'Group 2',previewGroup3:'Group 3',previewChannel1:'Channel 1',previewChannel2:'Channel 2',previewChannel3:'Channel 3',previewPlay:'opens channel',previewFav:'Hold OK for favourite',
      ...
      benefit3Title:'Find channels faster',benefit3Text:'Favourites, normal groups, Norwegian channels and Premier League make large playlists easier to use.',
      webEyebrow:'WEB PLAYER · BETA',webTitle:'Want to test in the browser?',webLead:'You can still open the M3U playlist here. The actual video stream must support browser playback, CORS and a compatible codec. For normal TV use, the Android TV app is recommended.',
      browserNoteTitle:'Why can VLC work when the browser does not?',browserNoteText:'Browsers enforce CORS and mixed-content rules that native players do not. Some IPTV sources therefore only work in the Android TV app or VLC.',
