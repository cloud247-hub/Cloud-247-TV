(() => {
  ...
  const i18n = {
    no: {
      ...
      previewSub:'DIN TV · DIN SPILLELISTE',norwegianChannels:'Norske kanaler',previewPlay:'åpner kanal',previewFav:'Hold OK for favoritt',
    ...
    en: {
      ...
      previewSub:'YOUR TV · YOUR PLAYLIST',norwegianChannels:'Norwegian channels',previewPlay:'opens channel',previewFav:'Hold OK for favourite',
