(() => {
  ...
  const i18n = {
    no: {
      ...
      navPair: 'Koble TV',
      nativeApp: 'ANDROID · v1.3.0 · SAMSUNG TV · v1.0.3',
      eyebrowNew: 'DIN TV · DIN SPILLELISTE',
      heroNew1: 'TV-en din.',
      heroNew2: 'Spillelisten din.',
      leadNew: 'Cloud247 TV gir deg et ryddig TV-grensesnitt for din egen M3U-liste på Android TV, Android-nettbrett og Samsung TV – med full TV-guide, Auto Frame Rate, touch/fjernkontroll og ny Night Mode med sleep timer.',
      pairTv: 'Koble TV',
    ...
    en: {
      ...
      leadNew: 'Cloud247 TV gives you a clean TV interface for your own M3U playlist on Android TV, Android tablets and Samsung TV, with a full TV guide, Auto Frame Rate, remote/touch controls and a new Night Mode with sleep timer.',
      pairTv: 'Pair TV',
      downloadAndroid: 'Android TV / Tablet',
      downloadSamsung: 'Samsung TV',
      pointDirect: 'Full TV guide / EPG',
